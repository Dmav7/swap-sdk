...
export interface WCROInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'name'
      | 'approve'
...
export interface WCRO extends BaseContract {
  connect(runner?: ContractRunner | null): WCRO
  waitForDeployment(): Promise<this>

  interface: WCROInterface
