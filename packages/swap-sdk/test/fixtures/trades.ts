        ...
        pool: [
          {
            ...
            version: PoolType.V2,
            token0Price: new Fraction('515952927702237770555932702981', '3355168269326000000000000'),
            token1Price: new Fraction('3355168269326000000000000', '515952927702237770555932702981'),
            reserve0: {
            ...
            reserve1: {
              amount: new Fraction('515952927702237770555932702981', '500000000000000000'),
              address: '0x904bd5a5aac0b9d88a0d47864724218986ad4a3a',
              symbol: 'VVS',
              decimals: 18,
            },
...
export function vvsToUsdcV2ExactOutputTrade(): Trade {
  return {
    ...
    routes: [
      {
        ...
        slippage: {
          ...
          maximumSold: {
            amount: new Fraction('145711838023632382959282831', '200000000000000000000'),
            address: '0x904bd5a5aac0b9d88a0d47864724218986ad4a3a',
            symbol: 'VVS',
            decimals: 18,
          },
    ...
    lpFeeRatio: new Fraction('3', '1000'),
    lpFee: {
      amount: new Fraction('2174803552591528103869893', '1000000000000000000000'),
      address: '0x904bd5a5aac0b9d88a0d47864724218986ad4a3a',
      symbol: 'VVS',
      decimals: 18,
    },
